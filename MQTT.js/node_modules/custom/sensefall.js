...
* SenseFall 
* 1. Description
* Keeps 30 records of gravitational force 
* to determine whether a fall is triggered based on the 
* min-max values difference in the given size window.
* 
* 2. References
...
function SenseFall(isDebug) {
  ...
  this.calculateGravity = function(xVal, yVal, zVal) {
    ...
    var result = this.roundUp((acceleration * this._sensitivity) / this._THOUSAND);
    if (isNaN(result)) {
      result = 0;
    }
    return result;	
